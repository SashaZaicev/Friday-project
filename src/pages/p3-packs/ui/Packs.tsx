...
import {actionsSearch, getSearch} from "../../p8-tableFilter/bll/searchReducer";
...
export const Packs = () => {
    ...
    const {searchName, page, pageCount,productTotalCount} = useSelector((state: AppRootStateType) => state.search.tableProducts.settingsSearch)
